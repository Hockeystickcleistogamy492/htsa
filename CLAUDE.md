...
The framework has six mathematical foundations. Read them in order — each one builds on the last.

[math/](math/) — Math foundations folder

| Step | File | Concept |
|---|---|---|
| 1 | [math/00_index.md](math/00_index.md) | Index — how the six concepts connect |
